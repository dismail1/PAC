...
$.getJSON('SampleData.json', function(data) {
          ...
          $(function () {
            ...
            d5.push([timeInSeconds[t], 2]);
            else
            d5.push(null);
            if (activity[t]=="Walking")
            d6.push([timeInSeconds[t], 3]);
            else
            d6.push(null);
            if (activity[t]=="Sitting")
            d7.push([timeInSeconds[t], 4]);
            else
            d7.push(null);
            if (activity[t]=="Standing")
            d8.push([timeInSeconds[t], 5]);
            else
            d8.push(null);
            if (activity[t]=="Misc")
            d9.push([timeInSeconds[t], 6]);
            else
            d9.push(null);
            }
            ...
            var ticks = [
            [1, "Lying"], [2, "Wheeling"], [3, "Walking"], [4, "Sitting"],
            [5, "Standing"], [6, "Misc"]
            ];
